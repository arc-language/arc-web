...
class EdgeRenderer {
  ...
  emitFetchHandler() {
    return [
      ...
      `              controller.enqueue(enc.encode('<body><main id="main-content" style="font-family:system-ui;padding:2rem;text-align:center"><h1>Something went wrong</h1><p>Please try refreshing the page.</p></main></body></html>'))`,
