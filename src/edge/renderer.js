...
class EdgeRenderer {
  ...
  emitFetchHandler() {
    return [
      ...
      `              controller.enqueue(_enc.encode('<body><main id="main-content" role="alert" style="font-family:system-ui;padding:2rem;text-align:center"><h1>Something went wrong</h1><p>Please try refreshing the page.</p></main></body></html>'))`,
