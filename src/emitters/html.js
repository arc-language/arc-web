...
const _LOCALE_SLIDER_NEXT = { en: 'Next slide', fr: 'Diapositive suivante', es: 'Diapositiva siguiente', de: 'Nächste Folie', pt: 'Próximo slide', ja: '次のスライド', zh: '下一张幻灯片', ar: 'الشريحة التالية' }
...
class HtmlEmitter {
  ...
  _emitHead(title, description, seo, jsonLd) {
    ...
    return [
      ...
      seo.image && seo.imageAlt ? `<meta name="twitter:image:alt" content="${this.escape(seo.imageAlt)}">` : '',
