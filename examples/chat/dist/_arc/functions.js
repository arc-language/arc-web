...
async function _handler_sendMessage(req) {
  try {
    ...
    const text = Object.prototype.hasOwnProperty.call(_body,'text') ? _body['text'] : undefined; const sender = Object.prototype.hasOwnProperty.call(_body,'sender') ? _body['sender'] : undefined
    ...
    console.error('[arc] @server sendMessage error:', _e)
